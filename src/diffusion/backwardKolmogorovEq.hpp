#ifndef MARIAN_BACKWARDKOLMOGOROVEQ_HPP
#define MARIAN_BACKWARDKOLMOGOROVEQ_HPP
...
namespace marian {
  ...
  /** \ingroup diffusion
   * \brief Class implements Backward Kolmogorow Equation
   *
   *
   * Backward Kolmogorow Equation arise in the theory of continuous-time continuous-state Markov processes.
   ...
   */   
  class BackwardKolmogorowEquation {
  public:
    /** \brief constructor
     */
...
#endif /* MARIAN_BACKWARDKOLMOGOROVEQ_HPP */
